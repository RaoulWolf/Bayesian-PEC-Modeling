...
This repository contains the data and the R scripts for Wolf & Tollefsen 2021, Environmental Science & Technology. *This README will be updated with the final details of the publication as soon as they are available.*
...
Additionally, the file `empirical_prior.R` contains a custom function to calculate empirical priors. Detailed information on the modelling procedure and the calculations of the empirical priors are given in the Supporting Information of the publication.